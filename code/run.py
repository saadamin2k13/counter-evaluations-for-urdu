...
def create_arg_parser():
    ...
    parser.add_argument("-t", "--train", required=False, type=str,
                        default=os.path.join(path, "data/pmb-5.0.0/seq2seq/en/train/gold_train.sbn"),
                        help="text input file")
    parser.add_argument("-dti", "--dev", required=False, type=str,
                        default=os.path.join(path, "data/pmb-5.0.0/seq2seq/en/dev/standard_testset.sbn"),
                        help="dev text input file")
    parser.add_argument("-tti", "--test", required=False, type=str,
                        default=os.path.join(path, "data/pmb-5.0.0/seq2seq/en/test/standard_testset.sbn"),
    ...
    parser.add_argument("-s", "--save1", required=False, type=str,
                        default=os.path.join(path, "src/model/byT5/result/byT5_baseline_1T.txt"),
